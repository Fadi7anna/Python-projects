...
class Planet:
    ...
    def draw(self, win):
        x = self.x * self.SCALE + WIDTH / 2  ##TO Draw in center
        ...
        if not self.sun:
            ...
            win.blit(distance_text, (x - distance_text.get_width()/2, y - distance_text.get_width()/2)) #get_height
    ...
    def update_pos(self, planets):
        ...
        self.y_vel += tota_fy / self.mass * self.TIMESTEP
